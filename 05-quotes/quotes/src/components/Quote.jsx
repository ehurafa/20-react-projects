...
const Quote = ({ text, author }) => {
  ...
  return (
    <div>
        ...
        <button className="btn btn-primary mr-1" onClick={ () => translateQuote("en") }>Traduzir para o inglês</button>
        <button className="btn btn-secondary m-1" onClick={ () => translateQuote("es") }>Traduzir para o espanhol</button>
    </div>
  )
}
